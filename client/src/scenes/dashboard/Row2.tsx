    ...
    return (
        ...
        <DashboardBox gridArea="d">
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <XAxis type="number" dataKey="price" name="price" tickLine={false} style={{fontSize:"10px"}} tickFormatter={(v) =>`$${v}`}/>
              <YAxis type="number" dataKey="expense" name="expense" tickLine={false} style={{fontSize:"10px"}} tickFormatter={(v) =>`$${v}`}/>
        ...
        <DashboardBox gridArea="e">
          <BoxHeader
            title="Targets"
          />
          <FlexBetween mt="0.25rem" gap="1.5rem" pr="1rem" height="60%">
            <PieChart
              width={110}
              height={100}
              margin={{
            ...
            <Box ml="-0.7rem" flexBasis="40%" textAlign="center">
              ...
              <Typography m="0.3rem 0" variant="h3" color={palette.primary[300]}>107</Typography>
